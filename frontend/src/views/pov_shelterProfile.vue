...
import { SparklesIcon, RectangleStackIcon, Square2StackIcon } from '@heroicons/vue/24/outline'
                ...
                <div v-show="currentTab === 'Pet Profile'" class="h-auto">
                    ...
                    <div v-else
                        ...
                        <img width="100" height="100"
                            src="https://img.icons8.com/external-becris-lineal-becris/100/737373/external-pet-hotel-service-becris-lineal-becris.png"
                            alt="external-pet-hotel-service-becris-lineal-becris" />
                        <h1 class="sm:text-xl lg:text-2xl font-extrabold">{{ profile.shelter }}'s Pets</h1>
                        <p class="text-sm font-medium flex text-center">
                            When {{ profile.shelter }}'s create a Pet Profile it'll appear
                            here.</p>
                    </div>
                </div>
                <!-- <div v-show="currentTab === 'Pet Profile'" class="h-auto">
