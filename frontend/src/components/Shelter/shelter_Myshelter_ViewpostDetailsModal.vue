            ...
            <div class="fixed inset-0 z-10 overflow-y-auto">
                <div class="flex min-h-full items-end justify-center text-center sm:items-center sm:p-0">
                    <TransitionChild as="template" enter="ease-out duration-300"
                        ...
                        <DialogPanel
                            class="relative transform overflow-hidden rounded-lg bg-white mx-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-fit">

                            <div
                                class="absolute z-10 sm:right-1 sm:top-1  md:right-3.5 md:top-3 bg-gray-50 bg-opacity-25 rounded-full flex items-center p-1 group">
                                <button @click="$emit('close')" ref="cancelButtonRef">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2"
                                        class="w-4 h-4 text-gray-600 sm:hover:text-white lg:hover:text-gray-500">
                            ...
                            <div class="flex flex-col items-center">
                                <div class="h-fit flex sm:flex-col md:flex-row">
                                    <div
                                        class="relative bg-slate-50 flex justify-center items-center sm:w-full md:w-[60%] xl:w-[60%]">
                                        <div
                                            ...
                                            <button v-if="hasPrev" @click="prevImage">
                                                <ChevronLeftIcon
                                                    class="sm:h-6 sm:w-6 lg:h-8 lg:w-8 text-gray-500 sm:hover:text-white" />
                                            </button>
                                        </div>
                                        <div>
                                    ...
                                    <div
                                        class="text-gray-700 sm:w-full md:w-[40%] xl:w-[40%] sm:py-[1rem] lg:py-[2rem] flex flex-col text-sm sm:border-t lg:border-l">
                                        <!-- display details -->
                                        <div class="flex items-center gap-x-2 border-b px-[2rem] pb-4">
                                        ...
                                        <div class="px-[2rem] py-[1rem] flex flex-col gap-y-2 sm:text-sm lg:text-base font-medium">
